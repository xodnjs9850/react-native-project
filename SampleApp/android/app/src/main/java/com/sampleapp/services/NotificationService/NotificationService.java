package com.sampleapp.services.NotificationService;
...
public class NotificationService {
    private static final String TAG = "PSJ_Notification";

    private static final String FOREGROUND_CHANNEL_ID = "aiq_home-bluetooth";
