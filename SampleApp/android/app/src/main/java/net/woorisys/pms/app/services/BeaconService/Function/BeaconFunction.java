...
import net.woorisys.pms.app.services.BeaconService.BeaconServiceUsage;
...
public class BeaconFunction {
    private static final String TAG = "KTW_BeaconFunction";
...
//              SimpleDateFormat full_sdf = new SimpleDateFormat("yyyy-MM-dd, hh:mm:ss : SSS", Locale.getDefault());
    ...
    public void OnlyOpenLobby(String uuid, int major, int minor, double rssi) {
        ...
        for (int i = 0; i < onepassList.size(); i++) {
            ...
            //Log.d(TAG, "lobbyMinor : " + lobbyMinor);
            //Log.d(TAG, "rssi : " + rssi);
            //Log.d(TAG, "lobbyRssi : " + lobbyRssi);
            //Log.d(TAG, "flag : " + lobbyMinor.equals(minorHex));
            //Log.d(TAG, "hex : " + minorHex);
